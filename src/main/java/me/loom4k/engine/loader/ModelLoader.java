package me.loom4k.engine.loader;
...
public class ModelLoader {
    ...
    public static Model loadModel(String modelId, String modelPath, TextureCache textureCache) {
        return loadModel(modelId, modelPath, textureCache, aiProcess_GenSmoothNormals |
                    aiProcess_JoinIdenticalVertices | // This flag reduces the number of vertices that are used
                    aiProcess_Triangulate | // The model may use quads or other geometries to define their elements, this splits all faces in triangles
                    aiProcess_FixInfacingNormals | // This flag tries to reverse normals that point inwards
                    ...
                    aiProcess_PreTransformVertices // This flag performs some transformation to make it coordinate with the math OpenGL coordinate System
        );
    }
    ...
    public static Model loadModel(String modelId, String modelPath, TextureCache textureCache, int flags) {
        ...
        for(int i = 0; i < numMaterials; i++) {
            ...
            materialList.add(processMaterial(aiMaterial, modelDirectory, textureCache));
        }
